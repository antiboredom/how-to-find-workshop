...
You may also want to identify the social media profiles of spouses and children, who might be more visible than your primary subject.
...
- PACER: [https://pacer.uscourts.gov/find-case/search-national-index](https://pacer.uscourts.gov/find-case/search-national-index)
    - **NOTE** You may be able to access PACER docs for free here: https://www.courtlistener.com/recap/ 
...
*Educational Institution 1 (year – year)*
-       Course of study and degree

*Educational Institution 2 (year – year)*
-       Course of study and degree

*Employer 1 (year – year)*
-       Position / title, and any relevant information about their time at the organization.

*Employer 2 (year – year)*

*Employer 3 (year – year)*

Places to search for professional histories:

- Google / DuckDuckGo for media
- Corporate bios (via Google)
- Newspapers.com for older media (this is great for local news, but you need a subscription)
- Nonprofit explorer: [https://projects.propublica.org/nonprofits/](https://projects.propublica.org/nonprofits/)
- PPP Loans: [https://projects.propublica.org/coronavirus/bailouts/](https://projects.propublica.org/coronavirus/bailouts/)
- USA Spending (search government contracts): [https://www.usaspending.gov/search](https://www.usaspending.gov/search)
- SEC filings: [https://www.sec.gov/edgar/search/](https://www.sec.gov/edgar/search/) (SEC filings often contain professional bios, but they also sometimes include charts of corporate architectures, and will frequently reveal board memberships and investments.)
- FINRA / broker check: [https://brokercheck.finra.org/](https://brokercheck.finra.org/)
- If you suspect that your subject may have a professional license of some kind, you can search their name in a state-level database, usually maintained by the Secretary of State. Here is the New York Department of Licensing search portal: [https://appext20.dos.ny.gov/lcns_public/lic_name_search_frm](https://appext20.dos.ny.gov/lcns_public/lic_name_search_frm)
- You may also search the state Bar Association, if your subject is a lawyer (look for any disciplinary actions):  [https://iapps.courts.state.ny.us/attorneyservices/search?0](https://iapps.courts.state.ny.us/attorneyservices/search?0)
...
As you search, make note of deeds and mortgages, and see if you can write out a chronology of your subject’s property holdings.

*Address of Property 1 (year – year)*

- You may be able to find the value of the home on the deed, or by looking at affiliated mortgage documents. This is a good way to understand how much debt your subject has (although in the case of billionaires, I would not expect to see mortgages.) Property records will also list parties as “husband and wife,” so this is a good way to verify who your subject is married to, if you’re having trouble determining.
- You can also look up the properties on Zillow and get an estimate of their current value.


## Additional, Potentially Interesting Portals

- FEC filings (search for campaign contributions): https://www.fec.gov/data/receipts/individual-contributions/?two_year_transaction_period=2026&min_date=01%2F01%2F2025&max_date=12%2F31%2F2026 
- Campaign contributions can also be search at the State and Municipal levels – 
- Cal-Access (California campaign contributions): https://dbsearch.sos.ca.gov/ 
- Los Angeles Ethics portal (LA contributions): https://ethics.lacity.gov/data/campaigns/contributions/#dt 
- Senate lobbyist portal (if your subject founded a business, it might be interesting to see what kinds of lobbyists they are hiring. You can also then search the names of lobbyists to see who they are donating to): https://lda.senate.gov/filings/public/filing/search/ 
- House lobbying portal (basically the same info as above, but with a worse interface: https://lobbyingdisclosure.house.gov/lookup.asp 
- Epstein files: https://www.justice.gov/epstein/search 
- Panama papers: https://offshoreleaks.icij.org/?gad_source=1&gad_campaignid=7587116103&gbraid=0AAAAACpCrOi1AJmUMVUIaq12Z0OCFDJNq&gclid=EAIaIQobChMIg7nonOW5kwMVRjMIBR2UVCSBEAAYASAAEgJIp_D_BwE 
