...
<html>
  ...
  <body>
    <div>
      ...
      <p>
        Many <strong>spectres</strong> are haunting Europe. Here are some of
        them:
      </p>
      ...
      <p>
        Keep reading to find out all of the spectres currently haunting Europe!
      </p>
    </div>
  </body>
</html>
...
Finally, it's important to note that an element might have _multiple_ classes. For example, this `p` element has three classes:

```html
<p class="big-paragraph important-content upsidedown">Hello!</p>
```

This means that any of the selectors `.big-paragraph`, `.important-content`, `.upsidedown` will apply to the element.
